...
To find the base URL for your company, go to [https://webservices.autotask.net/atservicesrest/v1.0/zoneInformation?user=](https://webservices.autotask.net/atservicesrest/v1.0/zoneInformation?user=){{ apiUser }} where `{{ apiUser }}` equals the username of your API user.
