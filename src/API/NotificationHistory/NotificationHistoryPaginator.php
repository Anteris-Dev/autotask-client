 ...
 */
class NotificationHistoryPaginator
{
    /** @var NotificationHistoryCollection Collection of notificationhistory. */
    public NotificationHistoryCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): NotificationHistoryPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): NotificationHistoryPaginator
    {
        if(is_null($this->postParams)){
