...
{
    /** @var ContractCollection Collection of contracts. */
    public ContractCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractPaginator
    {
        if(is_null($this->postParams)){
