 ...
 */
class TicketChargePaginator
{
    /** @var TicketChargeCollection Collection of ticketcharges. */
    public TicketChargeCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketChargeCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketChargePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketChargePaginator
    {
        if(is_null($this->postParams)){
