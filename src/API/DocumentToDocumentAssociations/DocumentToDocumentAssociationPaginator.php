 ...
 */
class DocumentToDocumentAssociationPaginator
{
    /** @var DocumentToDocumentAssociationCollection Collection of documenttodocumentassociations. */
    public DocumentToDocumentAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DocumentToDocumentAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): DocumentToDocumentAssociationPaginator
    {
