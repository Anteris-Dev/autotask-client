 ...
 */
class SalesOrderPaginator
{
    /** @var SalesOrderCollection Collection of salesorders. */
    public SalesOrderCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = SalesOrderCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): SalesOrderPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): SalesOrderPaginator
    {
        if(is_null($this->postParams)){
