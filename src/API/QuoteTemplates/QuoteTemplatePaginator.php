 ...
 */
class QuoteTemplatePaginator
{
    /** @var QuoteTemplateCollection Collection of quotetemplates. */
    public QuoteTemplateCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): QuoteTemplatePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): QuoteTemplatePaginator
    {
        if(is_null($this->postParams)){
