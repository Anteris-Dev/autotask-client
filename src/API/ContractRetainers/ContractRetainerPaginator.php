 ...
 */
class ContractRetainerPaginator
{
    /** @var ContractRetainerCollection Collection of contractretainers. */
    public ContractRetainerCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractRetainerPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractRetainerPaginator
    {
        if(is_null($this->postParams)){
