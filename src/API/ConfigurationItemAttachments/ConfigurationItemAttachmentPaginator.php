 ...
 */
class ConfigurationItemAttachmentPaginator
{
    /** @var ConfigurationItemAttachmentCollection Collection of configurationitemattachments. */
    public ConfigurationItemAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ConfigurationItemAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ConfigurationItemAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ConfigurationItemAttachmentPaginator
    {
        if(is_null($this->postParams)){
