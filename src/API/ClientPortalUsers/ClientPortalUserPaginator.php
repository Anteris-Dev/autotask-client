 ...
 */
class ClientPortalUserPaginator
{
    /** @var ClientPortalUserCollection Collection of clientportalusers. */
    public ClientPortalUserCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ClientPortalUserPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ClientPortalUserPaginator
    {
        if(is_null($this->postParams)){
