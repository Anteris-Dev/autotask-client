 ...
 */
class ConfigurationItemBillingProductAssociationPaginator
{
    /** @var ConfigurationItemBillingProductAssociationCollection Collection of configurationitembillingproductassociations. */
    public ConfigurationItemBillingProductAssociationCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ConfigurationItemBillingProductAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ConfigurationItemBillingProductAssociationPaginator
    {
        if(is_null($this->postParams)){
