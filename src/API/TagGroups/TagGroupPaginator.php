 ...
 */
class TagGroupPaginator
{
    /** @var TagGroupCollection Collection of taggroups. */
    public TagGroupCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TagGroupCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TagGroupPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TagGroupPaginator
    {
        if(is_null($this->postParams)){
