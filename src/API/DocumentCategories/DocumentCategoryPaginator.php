 ...
 */
class DocumentCategoryPaginator
{
    /** @var DocumentCategoryCollection Collection of documentcategories. */
    public DocumentCategoryCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DocumentCategoryCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): DocumentCategoryPaginator
    {
        if(is_null($this->postParams)){
