 ...
 */
class QuoteItemPaginator
{
    /** @var QuoteItemCollection Collection of quoteitems. */
    public QuoteItemCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = QuoteItemCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): QuoteItemPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): QuoteItemPaginator
    {
        if(is_null($this->postParams)){
