 ...
 */
class ContractBillingRulePaginator
{
    /** @var ContractBillingRuleCollection Collection of contractbillingrules. */
    public ContractBillingRuleCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractBillingRulePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractBillingRulePaginator
    {
        if(is_null($this->postParams)){
