 ...
 */
class DomainRegistrarPaginator
{
    /** @var DomainRegistrarCollection Collection of domainregistrars. */
    public DomainRegistrarCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DomainRegistrarCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): DomainRegistrarPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): DomainRegistrarPaginator
    {
        if(is_null($this->postParams)){
