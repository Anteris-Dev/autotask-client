 ...
 */
class TimeEntryPaginator
{
    /** @var TimeEntryCollection Collection of timeentries. */
    public TimeEntryCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TimeEntryCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TimeEntryPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TimeEntryPaginator
    {
        if(is_null($this->postParams)){
