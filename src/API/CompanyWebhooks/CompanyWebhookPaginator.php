 ...
 */
class CompanyWebhookPaginator
{
    /** @var CompanyWebhookCollection Collection of companywebhooks. */
    public CompanyWebhookCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CompanyWebhookPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CompanyWebhookPaginator
    {
        if(is_null($this->postParams)){
