 ...
 */
class BillingItemPaginator
{
    /** @var BillingItemCollection Collection of billingitems. */
    public BillingItemCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = BillingItemCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): BillingItemPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): BillingItemPaginator
    {
        if(is_null($this->postParams)){
