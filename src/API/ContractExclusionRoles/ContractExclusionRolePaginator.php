 ...
 */
class ContractExclusionRolePaginator
{
    /** @var ContractExclusionRoleCollection Collection of contractexclusionroles. */
    public ContractExclusionRoleCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractExclusionRoleCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractExclusionRolePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractExclusionRolePaginator
    {
        if(is_null($this->postParams)){
