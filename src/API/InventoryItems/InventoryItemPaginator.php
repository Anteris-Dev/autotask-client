 ...
 */
class InventoryItemPaginator
{
    /** @var InventoryItemCollection Collection of inventoryitems. */
    public InventoryItemCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): InventoryItemPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): InventoryItemPaginator
    {
        if(is_null($this->postParams)){
