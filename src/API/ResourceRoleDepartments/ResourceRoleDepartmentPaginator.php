 ...
 */
class ResourceRoleDepartmentPaginator
{
    /** @var ResourceRoleDepartmentCollection Collection of resourceroledepartments. */
    public ResourceRoleDepartmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ResourceRoleDepartmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ResourceRoleDepartmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ResourceRoleDepartmentPaginator
    {
        if(is_null($this->postParams)){
