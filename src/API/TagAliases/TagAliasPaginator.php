 ...
 */
class TagAliasPaginator
{
    /** @var TagAliasCollection Collection of tagaliases. */
    public TagAliasCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TagAliasCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TagAliasPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TagAliasPaginator
    {
        if(is_null($this->postParams)){
