 ...
 */
class KnowledgeBaseCategoryPaginator
{
    /** @var KnowledgeBaseCategoryCollection Collection of knowledgebasecategories. */
    public KnowledgeBaseCategoryCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = KnowledgeBaseCategoryCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): KnowledgeBaseCategoryPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): KnowledgeBaseCategoryPaginator
    {
        if(is_null($this->postParams)){
