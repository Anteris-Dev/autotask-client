 ...
 */
class PhasePaginator
{
    /** @var PhaseCollection Collection of phases. */
    public PhaseCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = PhaseCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): PhasePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): PhasePaginator
    {
        if(is_null($this->postParams)){
