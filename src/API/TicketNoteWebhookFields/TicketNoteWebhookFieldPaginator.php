 ...
 */
class TicketNoteWebhookFieldPaginator
{
    /** @var TicketNoteWebhookFieldCollection Collection of ticketnotewebhookfields. */
    public TicketNoteWebhookFieldCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketNoteWebhookFieldCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketNoteWebhookFieldPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketNoteWebhookFieldPaginator
    {
        if(is_null($this->postParams)){
