 ...
 */
class CompanyNotePaginator
{
    /** @var CompanyNoteCollection Collection of companynotes. */
    public CompanyNoteCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CompanyNotePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CompanyNotePaginator
    {
        if(is_null($this->postParams)){
