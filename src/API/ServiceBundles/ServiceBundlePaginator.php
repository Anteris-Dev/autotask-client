 ...
 */
class ServiceBundlePaginator
{
    /** @var ServiceBundleCollection Collection of servicebundles. */
    public ServiceBundleCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ServiceBundleCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ServiceBundlePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ServiceBundlePaginator
    {
        if(is_null($this->postParams)){
