 ...
 */
class ExpenseItemAttachmentPaginator
{
    /** @var ExpenseItemAttachmentCollection Collection of expenseitemattachments. */
    public ExpenseItemAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ExpenseItemAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ExpenseItemAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ExpenseItemAttachmentPaginator
    {
        if(is_null($this->postParams)){
