 ...
 */
class ConfigurationItemSslSubjectAlternativeNamePaginator
{
    /** @var ConfigurationItemSslSubjectAlternativeNameCollection Collection of configurationitemsslsubjectalternativenames. */
    public ConfigurationItemSslSubjectAlternativeNameCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ConfigurationItemSslSubjectAlternativeNameCollection::fromResponse($response);
