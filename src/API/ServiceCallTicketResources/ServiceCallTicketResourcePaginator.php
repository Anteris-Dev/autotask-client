 ...
 */
class ServiceCallTicketResourcePaginator
{
    /** @var ServiceCallTicketResourceCollection Collection of servicecallticketresources. */
    public ServiceCallTicketResourceCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ServiceCallTicketResourceCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ServiceCallTicketResourcePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ServiceCallTicketResourcePaginator
    {
        if(is_null($this->postParams)){
