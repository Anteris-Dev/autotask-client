 ...
 */
class ContactWebhookExcludedResourcePaginator
{
    /** @var ContactWebhookExcludedResourceCollection Collection of contactwebhookexcludedresources. */
    public ContactWebhookExcludedResourceCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContactWebhookExcludedResourceCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContactWebhookExcludedResourcePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContactWebhookExcludedResourcePaginator
    {
        if(is_null($this->postParams)){
