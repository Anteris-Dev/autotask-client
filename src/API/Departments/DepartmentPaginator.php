 ...
 */
class DepartmentPaginator
{
    /** @var DepartmentCollection Collection of departments. */
    public DepartmentCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): DepartmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): DepartmentPaginator
    {
        if(is_null($this->postParams)){
