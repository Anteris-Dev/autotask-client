 ...
 */
class QuotePaginator
{
    /** @var QuoteCollection Collection of quotes. */
    public QuoteCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = QuoteCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): QuotePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): QuotePaginator
    {
        if(is_null($this->postParams)){
