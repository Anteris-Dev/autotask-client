 ...
 */
class PriceListServicePaginator
{
    /** @var PriceListServiceCollection Collection of pricelistservices. */
    public PriceListServiceCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = PriceListServiceCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): PriceListServicePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): PriceListServicePaginator
    {
        if(is_null($this->postParams)){
