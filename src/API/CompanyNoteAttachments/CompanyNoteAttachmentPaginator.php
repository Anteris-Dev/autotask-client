 ...
 */
class CompanyNoteAttachmentPaginator
{
    /** @var CompanyNoteAttachmentCollection Collection of companynoteattachments. */
    public CompanyNoteAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = CompanyNoteAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CompanyNoteAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CompanyNoteAttachmentPaginator
    {
        if(is_null($this->postParams)){
