 ...
 */
class ContactGroupPaginator
{
    /** @var ContactGroupCollection Collection of contactgroups. */
    public ContactGroupCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContactGroupCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContactGroupPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContactGroupPaginator
    {
        if(is_null($this->postParams)){
