 ...
 */
class TicketWebhookUdfFieldPaginator
{
    /** @var TicketWebhookUdfFieldCollection Collection of ticketwebhookudffields. */
    public TicketWebhookUdfFieldCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketWebhookUdfFieldCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketWebhookUdfFieldPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketWebhookUdfFieldPaginator
    {
        if(is_null($this->postParams)){
