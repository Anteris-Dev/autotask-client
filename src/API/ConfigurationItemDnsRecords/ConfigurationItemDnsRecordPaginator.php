 ...
 */
class ConfigurationItemDnsRecordPaginator
{
    /** @var ConfigurationItemDnsRecordCollection Collection of configurationitemdnsrecords. */
    public ConfigurationItemDnsRecordCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ConfigurationItemDnsRecordCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ConfigurationItemDnsRecordPaginator
    {
        if(is_null($this->postParams)){
