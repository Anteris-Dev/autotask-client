 ...
 */
class ArticleToArticleAssociationPaginator
{
    /** @var ArticleToArticleAssociationCollection Collection of articletoarticleassociations. */
    public ArticleToArticleAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ArticleToArticleAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ArticleToArticleAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ArticleToArticleAssociationPaginator
    {
        if(is_null($this->postParams)){
