 ...
 */
class ContactWebhookPaginator
{
    /** @var ContactWebhookCollection Collection of contactwebhooks. */
    public ContactWebhookCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContactWebhookCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContactWebhookPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContactWebhookPaginator
    {
        if(is_null($this->postParams)){
