 ...
 */
class ServiceCallTaskResourcePaginator
{
    /** @var ServiceCallTaskResourceCollection Collection of servicecalltaskresources. */
    public ServiceCallTaskResourceCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ServiceCallTaskResourceCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ServiceCallTaskResourcePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ServiceCallTaskResourcePaginator
    {
        if(is_null($this->postParams)){
