 ...
 */
class InventoryItemSerialNumberPaginator
{
    /** @var InventoryItemSerialNumberCollection Collection of inventoryitemserialnumbers. */
    public InventoryItemSerialNumberCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = InventoryItemSerialNumberCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): InventoryItemSerialNumberPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): InventoryItemSerialNumberPaginator
    {
        if(is_null($this->postParams)){
