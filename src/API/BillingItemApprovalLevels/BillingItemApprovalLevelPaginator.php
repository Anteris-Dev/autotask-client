 ...
 */
class BillingItemApprovalLevelPaginator
{
    /** @var BillingItemApprovalLevelCollection Collection of billingitemapprovallevels. */
    public BillingItemApprovalLevelCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = BillingItemApprovalLevelCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): BillingItemApprovalLevelPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): BillingItemApprovalLevelPaginator
    {
        if(is_null($this->postParams)){
