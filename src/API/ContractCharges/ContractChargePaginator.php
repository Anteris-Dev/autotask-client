 ...
 */
class ContractChargePaginator
{
    /** @var ContractChargeCollection Collection of contractcharges. */
    public ContractChargeCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractChargeCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractChargePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractChargePaginator
    {
        if(is_null($this->postParams)){
