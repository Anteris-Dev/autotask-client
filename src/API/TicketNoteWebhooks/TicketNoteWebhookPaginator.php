 ...
 */
class TicketNoteWebhookPaginator
{
    /** @var TicketNoteWebhookCollection Collection of ticketnotewebhooks. */
    public TicketNoteWebhookCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketNoteWebhookCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketNoteWebhookPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketNoteWebhookPaginator
    {
        if(is_null($this->postParams)){
