 ...
 */
class AppointmentPaginator
{
    /** @var AppointmentCollection Collection of appointments. */
    public AppointmentCollection $collection;
    ...
    {
        $contacts = AppointmentCollection::fromResponse($response);
