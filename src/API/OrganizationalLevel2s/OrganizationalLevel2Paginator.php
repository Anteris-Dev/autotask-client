 ...
 */
class OrganizationalLevel2Paginator
{
    /** @var OrganizationalLevel2Collection Collection of organizationallevel2s. */
    public OrganizationalLevel2Collection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = OrganizationalLevel2Collection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): OrganizationalLevel2Paginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): OrganizationalLevel2Paginator
    {
        if(is_null($this->postParams)){
