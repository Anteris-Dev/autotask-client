 ...
 */
class TicketWebhookExcludedResourcePaginator
{
    /** @var TicketWebhookExcludedResourceCollection Collection of ticketwebhookexcludedresources. */
    public TicketWebhookExcludedResourceCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketWebhookExcludedResourceCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketWebhookExcludedResourcePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketWebhookExcludedResourcePaginator
    {
        if(is_null($this->postParams)){
