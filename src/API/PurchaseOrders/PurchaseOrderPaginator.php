 ...
 */
class PurchaseOrderPaginator
{
    /** @var PurchaseOrderCollection Collection of purchaseorders. */
    public PurchaseOrderCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = PurchaseOrderCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): PurchaseOrderPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): PurchaseOrderPaginator
    {
        if(is_null($this->postParams)){
