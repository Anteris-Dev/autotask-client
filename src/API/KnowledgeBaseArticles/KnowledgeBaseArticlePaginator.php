 ...
 */
class KnowledgeBaseArticlePaginator
{
    /** @var KnowledgeBaseArticleCollection Collection of knowledgebasearticles. */
    public KnowledgeBaseArticleCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = KnowledgeBaseArticleCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): KnowledgeBaseArticlePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): KnowledgeBaseArticlePaginator
    {
        if(is_null($this->postParams)){
