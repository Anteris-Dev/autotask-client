 ...
 */
class ResourceSkillPaginator
{
    /** @var ResourceSkillCollection Collection of resourceskills. */
    public ResourceSkillCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ResourceSkillCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ResourceSkillPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ResourceSkillPaginator
    {
        if(is_null($this->postParams)){
