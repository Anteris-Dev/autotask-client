 ...
 */
class ChangeRequestLinkPaginator
{
    /** @var ChangeRequestLinkCollection Collection of changerequestlinks. */
    public ChangeRequestLinkCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ChangeRequestLinkPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ChangeRequestLinkPaginator
    {
        if(is_null($this->postParams)){
