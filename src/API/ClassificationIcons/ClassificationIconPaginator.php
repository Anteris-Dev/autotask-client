 ...
 */
class ClassificationIconPaginator
{
    /** @var ClassificationIconCollection Collection of classificationicons. */
    public ClassificationIconCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ClassificationIconCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ClassificationIconPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ClassificationIconPaginator
    {
        if(is_null($this->postParams)){
