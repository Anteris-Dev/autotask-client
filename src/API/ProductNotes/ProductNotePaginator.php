 ...
 */
class ProductNotePaginator
{
    /** @var ProductNoteCollection Collection of productnotes. */
    public ProductNoteCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ProductNoteCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ProductNotePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ProductNotePaginator
    {
        if(is_null($this->postParams)){
