 ...
 */
class ContractServiceBundleUnitPaginator
{
    /** @var ContractServiceBundleUnitCollection Collection of contractservicebundleunits. */
    public ContractServiceBundleUnitCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractServiceBundleUnitCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractServiceBundleUnitPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractServiceBundleUnitPaginator
    {
        if(is_null($this->postParams)){
