...
{
    /** @var BillingCodeCollection Collection of billingcodes. */
    public BillingCodeCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = BillingCodeCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): BillingCodePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): BillingCodePaginator
    {
        if(is_null($this->postParams)){
