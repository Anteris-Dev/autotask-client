 ...
 */
class CompanyAlertPaginator
{
    /** @var CompanyAlertCollection Collection of companyalerts. */
    public CompanyAlertCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = CompanyAlertCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CompanyAlertPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CompanyAlertPaginator
    {
        if(is_null($this->postParams)){
