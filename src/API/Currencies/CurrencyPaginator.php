 ...
 */
class CurrencyPaginator
{
    /** @var CurrencyCollection Collection of currencies. */
    public CurrencyCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = CurrencyCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CurrencyPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CurrencyPaginator
    {
        if(is_null($this->postParams)){
