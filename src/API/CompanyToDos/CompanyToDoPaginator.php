 ...
 */
class CompanyToDoPaginator
{
    /** @var CompanyToDoCollection Collection of companytodos. */
    public CompanyToDoCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = CompanyToDoCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CompanyToDoPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CompanyToDoPaginator
    {
        if(is_null($this->postParams)){
