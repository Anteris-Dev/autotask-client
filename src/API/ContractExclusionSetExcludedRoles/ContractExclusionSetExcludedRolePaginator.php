 ...
 */
class ContractExclusionSetExcludedRolePaginator
{
    /** @var ContractExclusionSetExcludedRoleCollection Collection of contractexclusionsetexcludedroles. */
    public ContractExclusionSetExcludedRoleCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractExclusionSetExcludedRoleCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractExclusionSetExcludedRolePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractExclusionSetExcludedRolePaginator
    {
        if(is_null($this->postParams)){
