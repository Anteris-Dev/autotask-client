 ...
 */
class ConfigurationItemTypePaginator
{
    /** @var ConfigurationItemTypeCollection Collection of configurationitemtypes. */
    public ConfigurationItemTypeCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ConfigurationItemTypeCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ConfigurationItemTypePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ConfigurationItemTypePaginator
    {
        if(is_null($this->postParams)){
