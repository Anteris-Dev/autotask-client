 ...
 */
class OpportunityPaginator
{
    /** @var OpportunityCollection Collection of opportunities. */
    public OpportunityCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = OpportunityCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): OpportunityPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): OpportunityPaginator
    {
        if(is_null($this->postParams)){
