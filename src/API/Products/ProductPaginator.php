...
{
    /** @var ProductCollection Collection of products. */
    ...
    {
        $this->client = $client;
        $this->collection = ProductCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ProductPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ProductPaginator
    {
        if(is_null($this->postParams)){
