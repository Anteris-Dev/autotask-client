 ...
 */
class TicketWebhookFieldPaginator
{
    /** @var TicketWebhookFieldCollection Collection of ticketwebhookfields. */
    public TicketWebhookFieldCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketWebhookFieldCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketWebhookFieldPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketWebhookFieldPaginator
    {
        if(is_null($this->postParams)){
