 ...
 */
class ResourceRoleQueuePaginator
{
    /** @var ResourceRoleQueueCollection Collection of resourcerolequeues. */
    public ResourceRoleQueueCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ResourceRoleQueueCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ResourceRoleQueuePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ResourceRoleQueuePaginator
    {
        if(is_null($this->postParams)){
