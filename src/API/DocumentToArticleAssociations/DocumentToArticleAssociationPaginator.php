 ...
 */
class DocumentToArticleAssociationPaginator
{
    /** @var DocumentToArticleAssociationCollection Collection of documenttoarticleassociations. */
    public DocumentToArticleAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DocumentToArticleAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): DocumentToArticleAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): DocumentToArticleAssociationPaginator
    {
        if(is_null($this->postParams)){
