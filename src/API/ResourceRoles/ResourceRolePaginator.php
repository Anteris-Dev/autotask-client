 ...
 */
class ResourceRolePaginator
{
    /** @var ResourceRoleCollection Collection of resourceroles. */
    public ResourceRoleCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ResourceRoleCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ResourceRolePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ResourceRolePaginator
    {
        if(is_null($this->postParams)){
