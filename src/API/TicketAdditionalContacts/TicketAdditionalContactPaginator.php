 ...
 */
class TicketAdditionalContactPaginator
{
    /** @var TicketAdditionalContactCollection Collection of ticketadditionalcontacts. */
    public TicketAdditionalContactCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketAdditionalContactCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketAdditionalContactPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketAdditionalContactPaginator
    {
        if(is_null($this->postParams)){
