 ...
 */
class WorkTypeModifierPaginator
{
    /** @var WorkTypeModifierCollection Collection of worktypemodifiers. */
    public WorkTypeModifierCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = WorkTypeModifierCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): WorkTypeModifierPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): WorkTypeModifierPaginator
    {
        if(is_null($this->postParams)){
