 ...
 */
class ConfigurationItemWebhookExcludedResourcePaginator
{
    /** @var ConfigurationItemWebhookExcludedResourceCollection Collection of configurationitemwebhookexcludedresources. */
    public ConfigurationItemWebhookExcludedResourceCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ConfigurationItemWebhookExcludedResourceCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ConfigurationItemWebhookExcludedResourcePaginator
    {
