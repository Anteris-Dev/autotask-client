 ...
 */
class ResourceAttachmentPaginator
{
    /** @var ResourceAttachmentCollection Collection of resourceattachments. */
    public ResourceAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ResourceAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ResourceAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ResourceAttachmentPaginator
    {
        if(is_null($this->postParams)){
