 ...
 */
class InventoryLocationPaginator
{
    /** @var InventoryLocationCollection Collection of inventorylocations. */
    public InventoryLocationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = InventoryLocationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): InventoryLocationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): InventoryLocationPaginator
    {
        if(is_null($this->postParams)){
