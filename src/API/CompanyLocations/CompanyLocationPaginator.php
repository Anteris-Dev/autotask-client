 ...
 */
class CompanyLocationPaginator
{
    /** @var CompanyLocationCollection Collection of companylocations. */
    public CompanyLocationCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CompanyLocationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CompanyLocationPaginator
    {
        if(is_null($this->postParams)){
