 ...
 */
class ComanagedAssociationPaginator
{
    /** @var ComanagedAssociationCollection Collection of comanagedassociations. */
    public ComanagedAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ComanagedAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ComanagedAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ComanagedAssociationPaginator
    {
        if(is_null($this->postParams)){
