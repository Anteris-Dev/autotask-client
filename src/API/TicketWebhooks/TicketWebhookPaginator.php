 ...
 */
class TicketWebhookPaginator
{
    /** @var TicketWebhookCollection Collection of ticketwebhooks. */
    public TicketWebhookCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketWebhookCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketWebhookPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketWebhookPaginator
    {
        if(is_null($this->postParams)){
