 ...
 */
class AdditionalInvoiceFieldValuePaginator
{
    /** @var AdditionalInvoiceFieldValueCollection Collection of additionalinvoicefieldvalues. */
    public AdditionalInvoiceFieldValueCollection $collection;
    ...
    {
        $contacts = AdditionalInvoiceFieldValueCollection::fromResponse($response);
