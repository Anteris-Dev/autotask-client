 ...
 */
class ConfigurationItemCategoryPaginator
{
    /** @var ConfigurationItemCategoryCollection Collection of configurationitemcategories. */
    public ConfigurationItemCategoryCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ConfigurationItemCategoryCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ConfigurationItemCategoryPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ConfigurationItemCategoryPaginator
    {
        if(is_null($this->postParams)){
