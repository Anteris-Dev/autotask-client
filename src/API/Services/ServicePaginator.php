...
{
    /** @var ServiceCollection Collection of services. */
    ...
    {
        $this->client = $client;
        $this->collection = ServiceCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ServicePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ServicePaginator
    {
        if(is_null($this->postParams)){
