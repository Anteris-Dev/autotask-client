 ...
 */
class TicketHistoryPaginator
{
    /** @var TicketHistoryCollection Collection of tickethistory. */
    public TicketHistoryCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketHistoryCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketHistoryPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketHistoryPaginator
    {
        if(is_null($this->postParams)){
