 ...
 */
class SurveyPaginator
{
    /** @var SurveyCollection Collection of surveys. */
    public SurveyCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = SurveyCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): SurveyPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): SurveyPaginator
    {
        if(is_null($this->postParams)){
