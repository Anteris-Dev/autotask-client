 ...
 */
class TicketCategoryFieldDefaultPaginator
{
    /** @var TicketCategoryFieldDefaultCollection Collection of ticketcategoryfielddefaults. */
    public TicketCategoryFieldDefaultCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketCategoryFieldDefaultCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketCategoryFieldDefaultPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketCategoryFieldDefaultPaginator
    {
        if(is_null($this->postParams)){
