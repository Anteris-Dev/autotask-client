 ...
 */
class ContractExclusionBillingCodePaginator
{
    /** @var ContractExclusionBillingCodeCollection Collection of contractexclusionbillingcodes. */
    public ContractExclusionBillingCodeCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractExclusionBillingCodeCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractExclusionBillingCodePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractExclusionBillingCodePaginator
    {
        if(is_null($this->postParams)){
