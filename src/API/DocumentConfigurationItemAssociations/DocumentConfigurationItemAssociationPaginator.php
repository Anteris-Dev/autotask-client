 ...
 */
class DocumentConfigurationItemAssociationPaginator
{
    /** @var DocumentConfigurationItemAssociationCollection Collection of documentconfigurationitemassociations. */
    public DocumentConfigurationItemAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DocumentConfigurationItemAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): DocumentConfigurationItemAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): DocumentConfigurationItemAssociationPaginator
    {
        if(is_null($this->postParams)){
