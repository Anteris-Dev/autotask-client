 ...
 */
class ContractRoleCostPaginator
{
    /** @var ContractRoleCostCollection Collection of contractrolecosts. */
    public ContractRoleCostCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractRoleCostPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractRoleCostPaginator
    {
        if(is_null($this->postParams)){
