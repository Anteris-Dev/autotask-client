 ...
 */
class TaskNoteAttachmentPaginator
{
    /** @var TaskNoteAttachmentCollection Collection of tasknoteattachments. */
    public TaskNoteAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TaskNoteAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TaskNoteAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TaskNoteAttachmentPaginator
    {
        if(is_null($this->postParams)){
