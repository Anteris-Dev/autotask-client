 ...
 */
class ChecklistLibraryChecklistItemPaginator
{
    /** @var ChecklistLibraryChecklistItemCollection Collection of checklistlibrarychecklistitems. */
    public ChecklistLibraryChecklistItemCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ChecklistLibraryChecklistItemPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ChecklistLibraryChecklistItemPaginator
    {
        if(is_null($this->postParams)){
