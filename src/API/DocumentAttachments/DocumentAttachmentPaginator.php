 ...
 */
class DocumentAttachmentPaginator
{
    /** @var DocumentAttachmentCollection Collection of documentattachments. */
    public DocumentAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DocumentAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): DocumentAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): DocumentAttachmentPaginator
    {
        if(is_null($this->postParams)){
