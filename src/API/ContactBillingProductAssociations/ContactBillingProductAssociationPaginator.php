 ...
 */
class ContactBillingProductAssociationPaginator
{
    /** @var ContactBillingProductAssociationCollection Collection of contactbillingproductassociations. */
    public ContactBillingProductAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContactBillingProductAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContactBillingProductAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContactBillingProductAssociationPaginator
    {
        if(is_null($this->postParams)){
