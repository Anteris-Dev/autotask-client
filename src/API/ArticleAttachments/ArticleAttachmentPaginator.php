 ...
 */
class ArticleAttachmentPaginator
{
    /** @var ArticleAttachmentCollection Collection of articleattachments. */
    public ArticleAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ArticleAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ArticleAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ArticleAttachmentPaginator
    {
        if(is_null($this->postParams)){
