...
class TaxPaginator
{
    /** @var TaxCollection Collection of taxes. */
    public TaxCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TaxCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TaxPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TaxPaginator
    {
        if(is_null($this->postParams)){
