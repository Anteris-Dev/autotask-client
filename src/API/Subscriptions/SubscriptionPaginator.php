...
{
    /** @var SubscriptionCollection Collection of subscriptions. */
    ...
    {
        $this->client = $client;
        $this->collection = SubscriptionCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): SubscriptionPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): SubscriptionPaginator
    {
        if(is_null($this->postParams)){
