 ...
 */
class InventoryStockedItemPaginator
{
    /** @var InventoryStockedItemCollection Collection of inventorystockeditems. */
    public InventoryStockedItemCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = InventoryStockedItemCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): InventoryStockedItemPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): InventoryStockedItemPaginator
    {
        if(is_null($this->postParams)){
