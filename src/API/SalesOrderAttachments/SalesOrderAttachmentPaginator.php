 ...
 */
class SalesOrderAttachmentPaginator
{
    /** @var SalesOrderAttachmentCollection Collection of salesorderattachments. */
    public SalesOrderAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = SalesOrderAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): SalesOrderAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): SalesOrderAttachmentPaginator
    {
        if(is_null($this->postParams)){
