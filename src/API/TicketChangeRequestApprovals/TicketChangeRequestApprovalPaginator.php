 ...
 */
class TicketChangeRequestApprovalPaginator
{
    /** @var TicketChangeRequestApprovalCollection Collection of ticketchangerequestapprovals. */
    public TicketChangeRequestApprovalCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketChangeRequestApprovalPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketChangeRequestApprovalPaginator
    {
        if(is_null($this->postParams)){
