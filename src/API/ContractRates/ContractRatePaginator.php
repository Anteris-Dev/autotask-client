 ...
 */
class ContractRatePaginator
{
    /** @var ContractRateCollection Collection of contractrates. */
    public ContractRateCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractRateCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractRatePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractRatePaginator
    {
        if(is_null($this->postParams)){
