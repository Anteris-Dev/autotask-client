 ...
 */
class TicketCategoryPaginator
{
    /** @var TicketCategoryCollection Collection of ticketcategories. */
    public TicketCategoryCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketCategoryCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketCategoryPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketCategoryPaginator
    {
        if(is_null($this->postParams)){
