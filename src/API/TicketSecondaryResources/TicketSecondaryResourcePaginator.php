 ...
 */
class TicketSecondaryResourcePaginator
{
    /** @var TicketSecondaryResourceCollection Collection of ticketsecondaryresources. */
    public TicketSecondaryResourceCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketSecondaryResourceCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketSecondaryResourcePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketSecondaryResourcePaginator
    {
        if(is_null($this->postParams)){
