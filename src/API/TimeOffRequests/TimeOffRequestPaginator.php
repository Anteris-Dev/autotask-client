 ...
 */
class TimeOffRequestPaginator
{
    /** @var TimeOffRequestCollection Collection of timeoffrequests. */
    public TimeOffRequestCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TimeOffRequestCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TimeOffRequestPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TimeOffRequestPaginator
    {
        if(is_null($this->postParams)){
