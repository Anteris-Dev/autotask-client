 ...
 */
class ContractBlockHourFactorPaginator
{
    /** @var ContractBlockHourFactorCollection Collection of contractblockhourfactors. */
    public ContractBlockHourFactorCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractBlockHourFactorPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractBlockHourFactorPaginator
    {
        if(is_null($this->postParams)){
