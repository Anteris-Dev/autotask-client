 ...
 */
class ServiceBundleServicePaginator
{
    /** @var ServiceBundleServiceCollection Collection of servicebundleservices. */
    public ServiceBundleServiceCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ServiceBundleServiceCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ServiceBundleServicePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ServiceBundleServicePaginator
    {
        if(is_null($this->postParams)){
