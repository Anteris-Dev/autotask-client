 ...
 */
class CompanyPaginator
{
    /** @var CompanyCollection Collection of companies. */
    public CompanyCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = CompanyCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CompanyPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CompanyPaginator
    {
        if(is_null($this->postParams)){
