 ...
 */
class ProjectAttachmentPaginator
{
    /** @var ProjectAttachmentCollection Collection of projectattachments. */
    public ProjectAttachmentCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ProjectAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ProjectAttachmentPaginator
    {
        if(is_null($this->postParams)){
