 ...
 */
class ExpenseReportAttachmentPaginator
{
    /** @var ExpenseReportAttachmentCollection Collection of expensereportattachments. */
    public ExpenseReportAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ExpenseReportAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ExpenseReportAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ExpenseReportAttachmentPaginator
    {
        if(is_null($this->postParams)){
