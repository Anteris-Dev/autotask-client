 ...
 */
class ArticleNotePaginator
{
    /** @var ArticleNoteCollection Collection of articlenotes. */
    public ArticleNoteCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ArticleNoteCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ArticleNotePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ArticleNotePaginator
    {
        if(is_null($this->postParams)){
