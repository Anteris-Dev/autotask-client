 ...
 */
class OpportunityAttachmentPaginator
{
    /** @var OpportunityAttachmentCollection Collection of opportunityattachments. */
    public OpportunityAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = OpportunityAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): OpportunityAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): OpportunityAttachmentPaginator
    {
        if(is_null($this->postParams)){
