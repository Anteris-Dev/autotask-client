 ...
 */
class QuoteLocationPaginator
{
    /** @var QuoteLocationCollection Collection of quotelocations. */
    public QuoteLocationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = QuoteLocationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): QuoteLocationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): QuoteLocationPaginator
    {
        if(is_null($this->postParams)){
