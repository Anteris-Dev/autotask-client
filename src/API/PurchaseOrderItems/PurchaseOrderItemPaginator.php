 ...
 */
class PurchaseOrderItemPaginator
{
    /** @var PurchaseOrderItemCollection Collection of purchaseorderitems. */
    public PurchaseOrderItemCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = PurchaseOrderItemCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): PurchaseOrderItemPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): PurchaseOrderItemPaginator
    {
        if(is_null($this->postParams)){
