 ...
 */
class PriceListProductPaginator
{
    /** @var PriceListProductCollection Collection of pricelistproducts. */
    public PriceListProductCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): PriceListProductPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): PriceListProductPaginator
    {
        if(is_null($this->postParams)){
