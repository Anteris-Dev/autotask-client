 ...
 */
class DocumentTicketAssociationPaginator
{
    /** @var DocumentTicketAssociationCollection Collection of documentticketassociations. */
    public DocumentTicketAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DocumentTicketAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): DocumentTicketAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): DocumentTicketAssociationPaginator
    {
        if(is_null($this->postParams)){
