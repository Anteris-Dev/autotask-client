 ...
 */
class CompanySiteConfigurationPaginator
{
    /** @var CompanySiteConfigurationCollection Collection of companysiteconfigurations. */
    public CompanySiteConfigurationCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CompanySiteConfigurationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CompanySiteConfigurationPaginator
    {
        if(is_null($this->postParams)){
