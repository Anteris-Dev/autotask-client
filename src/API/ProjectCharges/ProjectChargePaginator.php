 ...
 */
class ProjectChargePaginator
{
    /** @var ProjectChargeCollection Collection of projectcharges. */
    public ProjectChargeCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ProjectChargePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ProjectChargePaginator
    {
        if(is_null($this->postParams)){
