 ...
 */
class PurchaseApprovalPaginator
{
    /** @var PurchaseApprovalCollection Collection of purchaseapprovals. */
    public PurchaseApprovalCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = PurchaseApprovalCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): PurchaseApprovalPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): PurchaseApprovalPaginator
    {
        if(is_null($this->postParams)){
