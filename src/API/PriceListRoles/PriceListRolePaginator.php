 ...
 */
class PriceListRolePaginator
{
    /** @var PriceListRoleCollection Collection of pricelistroles. */
    public PriceListRoleCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): PriceListRolePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): PriceListRolePaginator
    {
        if(is_null($this->postParams)){
