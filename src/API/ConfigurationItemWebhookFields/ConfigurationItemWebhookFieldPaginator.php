 ...
 */
class ConfigurationItemWebhookFieldPaginator
{
    /** @var ConfigurationItemWebhookFieldCollection Collection of configurationitemwebhookfields. */
    public ConfigurationItemWebhookFieldCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ConfigurationItemWebhookFieldCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ConfigurationItemWebhookFieldPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ConfigurationItemWebhookFieldPaginator
    {
        if(is_null($this->postParams)){
