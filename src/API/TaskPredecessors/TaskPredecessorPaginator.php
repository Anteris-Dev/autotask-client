 ...
 */
class TaskPredecessorPaginator
{
    /** @var TaskPredecessorCollection Collection of taskpredecessors. */
    public TaskPredecessorCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TaskPredecessorCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TaskPredecessorPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TaskPredecessorPaginator
    {
        if(is_null($this->postParams)){
