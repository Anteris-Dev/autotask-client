 ...
 */
class DocumentPlainTextContentPaginator
{
    /** @var DocumentPlainTextContentCollection Collection of documentplaintextcontent. */
    public DocumentPlainTextContentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DocumentPlainTextContentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): DocumentPlainTextContentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): DocumentPlainTextContentPaginator
    {
        if(is_null($this->postParams)){
