 ...
 */
class ConfigurationItemRelatedItemPaginator
{
    /** @var ConfigurationItemRelatedItemCollection Collection of configurationitemrelateditems. */
    public ConfigurationItemRelatedItemCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ConfigurationItemRelatedItemCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ConfigurationItemRelatedItemPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ConfigurationItemRelatedItemPaginator
    {
        if(is_null($this->postParams)){
