 ...
 */
class ProductTierPaginator
{
    /** @var ProductTierCollection Collection of producttiers. */
    public ProductTierCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ProductTierCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ProductTierPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ProductTierPaginator
    {
        if(is_null($this->postParams)){
