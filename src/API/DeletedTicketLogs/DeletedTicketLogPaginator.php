 ...
 */
class DeletedTicketLogPaginator
{
    /** @var DeletedTicketLogCollection Collection of deletedticketlogs. */
    public DeletedTicketLogCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DeletedTicketLogCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): DeletedTicketLogPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): DeletedTicketLogPaginator
    {
        if(is_null($this->postParams)){
