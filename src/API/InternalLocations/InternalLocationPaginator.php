 ...
 */
class InternalLocationPaginator
{
    /** @var InternalLocationCollection Collection of internallocations. */
    public InternalLocationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = InternalLocationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): InternalLocationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): InternalLocationPaginator
    {
        if(is_null($this->postParams)){
