 ...
 */
class PriceListWorkTypeModifierPaginator
{
    /** @var PriceListWorkTypeModifierCollection Collection of pricelistworktypemodifiers. */
    public PriceListWorkTypeModifierCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = PriceListWorkTypeModifierCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): PriceListWorkTypeModifierPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): PriceListWorkTypeModifierPaginator
    {
        if(is_null($this->postParams)){
