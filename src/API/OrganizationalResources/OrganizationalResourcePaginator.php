 ...
 */
class OrganizationalResourcePaginator
{
    /** @var OrganizationalResourceCollection Collection of organizationalresources. */
    public OrganizationalResourceCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = OrganizationalResourceCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): OrganizationalResourcePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): OrganizationalResourcePaginator
    {
        if(is_null($this->postParams)){
