...
{
    /** @var InvoiceCollection Collection of invoices. */
    public InvoiceCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): InvoicePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): InvoicePaginator
    {
        if(is_null($this->postParams)){
