 ...
 */
class AttachmentInfoPaginator
{
    /** @var AttachmentInfoCollection Collection of attachmentinfo. */
    public AttachmentInfoCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = AttachmentInfoCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): AttachmentInfoPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): AttachmentInfoPaginator
    {
        if(is_null($this->postParams)){
