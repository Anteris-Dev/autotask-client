 ...
 */
class DocumentTagAssociationPaginator
{
    /** @var DocumentTagAssociationCollection Collection of documenttagassociations. */
    public DocumentTagAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DocumentTagAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): DocumentTagAssociationPaginator
    {
