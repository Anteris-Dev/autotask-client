 ...
 */
class TaskSecondaryResourcePaginator
{
    /** @var TaskSecondaryResourceCollection Collection of tasksecondaryresources. */
    public TaskSecondaryResourceCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TaskSecondaryResourceCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TaskSecondaryResourcePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TaskSecondaryResourcePaginator
    {
        if(is_null($this->postParams)){
