 ...
 */
class ContactGroupContactPaginator
{
    /** @var ContactGroupContactCollection Collection of contactgroupcontacts. */
    public ContactGroupContactCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContactGroupContactCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContactGroupContactPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContactGroupContactPaginator
    {
        if(is_null($this->postParams)){
