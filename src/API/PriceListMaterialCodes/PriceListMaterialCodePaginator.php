 ...
 */
class PriceListMaterialCodePaginator
{
    /** @var PriceListMaterialCodeCollection Collection of pricelistmaterialcodes. */
    public PriceListMaterialCodeCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = PriceListMaterialCodeCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): PriceListMaterialCodePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): PriceListMaterialCodePaginator
    {
        if(is_null($this->postParams)){
