 ...
 */
class CompanyCategoryPaginator
{
    /** @var CompanyCategoryCollection Collection of companycategories. */
    public CompanyCategoryCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = CompanyCategoryCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CompanyCategoryPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CompanyCategoryPaginator
    {
        if(is_null($this->postParams)){
