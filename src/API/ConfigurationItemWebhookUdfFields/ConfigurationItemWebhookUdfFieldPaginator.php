 ...
 */
class ConfigurationItemWebhookUdfFieldPaginator
{
    /** @var ConfigurationItemWebhookUdfFieldCollection Collection of configurationitemwebhookudffields. */
    public ConfigurationItemWebhookUdfFieldCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ConfigurationItemWebhookUdfFieldCollection::fromResponse($response);
