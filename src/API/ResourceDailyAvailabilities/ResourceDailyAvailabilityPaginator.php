 ...
 */
class ResourceDailyAvailabilityPaginator
{
    /** @var ResourceDailyAvailabilityCollection Collection of resourcedailyavailabilities. */
    public ResourceDailyAvailabilityCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ResourceDailyAvailabilityCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ResourceDailyAvailabilityPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ResourceDailyAvailabilityPaginator
    {
        if(is_null($this->postParams)){
