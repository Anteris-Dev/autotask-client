 ...
 */
class TicketRmaCreditPaginator
{
    /** @var TicketRmaCreditCollection Collection of ticketrmacredits. */
    public TicketRmaCreditCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketRmaCreditCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketRmaCreditPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketRmaCreditPaginator
    {
        if(is_null($this->postParams)){
