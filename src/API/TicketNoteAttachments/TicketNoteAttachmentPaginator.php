 ...
 */
class TicketNoteAttachmentPaginator
{
    /** @var TicketNoteAttachmentCollection Collection of ticketnoteattachments. */
    public TicketNoteAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketNoteAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketNoteAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketNoteAttachmentPaginator
    {
        if(is_null($this->postParams)){
