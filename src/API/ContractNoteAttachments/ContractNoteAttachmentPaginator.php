 ...
 */
class ContractNoteAttachmentPaginator
{
    /** @var ContractNoteAttachmentCollection Collection of contractnoteattachments. */
    public ContractNoteAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractNoteAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractNoteAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractNoteAttachmentPaginator
    {
        if(is_null($this->postParams)){
