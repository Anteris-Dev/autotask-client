 ...
 */
class DocumentChecklistItemPaginator
{
    /** @var DocumentChecklistItemCollection Collection of documentchecklistitems. */
    public DocumentChecklistItemCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DocumentChecklistItemCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): DocumentChecklistItemPaginator
    {
        if(is_null($this->postParams)){
