 ...
 */
class ArticlePlainTextContentPaginator
{
    /** @var ArticlePlainTextContentCollection Collection of articleplaintextcontent. */
    public ArticlePlainTextContentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ArticlePlainTextContentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ArticlePlainTextContentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ArticlePlainTextContentPaginator
    {
        if(is_null($this->postParams)){
