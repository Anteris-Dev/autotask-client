 ...
 */
class ContractBlockPaginator
{
    /** @var ContractBlockCollection Collection of contractblocks. */
    public ContractBlockCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractBlockPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractBlockPaginator
    {
        if(is_null($this->postParams)){
