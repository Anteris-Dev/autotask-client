 ...
 */
class TaskNotePaginator
{
    /** @var TaskNoteCollection Collection of tasknotes. */
    public TaskNoteCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TaskNoteCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TaskNotePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TaskNotePaginator
    {
        if(is_null($this->postParams)){
