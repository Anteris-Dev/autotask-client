 ...
 */
class ChangeOrderChargePaginator
{
    /** @var ChangeOrderChargeCollection Collection of changeordercharges. */
    public ChangeOrderChargeCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ChangeOrderChargePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ChangeOrderChargePaginator
    {
        if(is_null($this->postParams)){
