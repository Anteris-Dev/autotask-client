 ...
 */
class CompanyWebhookFieldPaginator
{
    /** @var CompanyWebhookFieldCollection Collection of companywebhookfields. */
    public CompanyWebhookFieldCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = CompanyWebhookFieldCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CompanyWebhookFieldPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CompanyWebhookFieldPaginator
    {
        if(is_null($this->postParams)){
