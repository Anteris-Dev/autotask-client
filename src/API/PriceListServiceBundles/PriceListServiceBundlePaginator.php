 ...
 */
class PriceListServiceBundlePaginator
{
    /** @var PriceListServiceBundleCollection Collection of pricelistservicebundles. */
    public PriceListServiceBundleCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = PriceListServiceBundleCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): PriceListServiceBundlePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): PriceListServiceBundlePaginator
    {
        if(is_null($this->postParams)){
