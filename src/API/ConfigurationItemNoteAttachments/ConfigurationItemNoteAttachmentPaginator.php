 ...
 */
class ConfigurationItemNoteAttachmentPaginator
{
    /** @var ConfigurationItemNoteAttachmentCollection Collection of configurationitemnoteattachments. */
    public ConfigurationItemNoteAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ConfigurationItemNoteAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ConfigurationItemNoteAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ConfigurationItemNoteAttachmentPaginator
    {
        if(is_null($this->postParams)){
