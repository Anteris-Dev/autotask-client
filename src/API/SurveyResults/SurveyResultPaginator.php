 ...
 */
class SurveyResultPaginator
{
    /** @var SurveyResultCollection Collection of surveyresults. */
    public SurveyResultCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): SurveyResultPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): SurveyResultPaginator
    {
        if(is_null($this->postParams)){
