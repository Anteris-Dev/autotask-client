 ...
 */
class ArticleTagAssociationPaginator
{
    /** @var ArticleTagAssociationCollection Collection of articletagassociations. */
    public ArticleTagAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ArticleTagAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ArticleTagAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ArticleTagAssociationPaginator
    {
        if(is_null($this->postParams)){
