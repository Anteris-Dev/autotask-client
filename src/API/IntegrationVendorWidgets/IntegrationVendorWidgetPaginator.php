 ...
 */
class IntegrationVendorWidgetPaginator
{
    /** @var IntegrationVendorWidgetCollection Collection of integrationvendorwidgets. */
    public IntegrationVendorWidgetCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = IntegrationVendorWidgetCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): IntegrationVendorWidgetPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): IntegrationVendorWidgetPaginator
    {
        if(is_null($this->postParams)){
