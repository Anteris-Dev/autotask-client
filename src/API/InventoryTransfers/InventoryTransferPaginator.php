 ...
 */
class InventoryTransferPaginator
{
    /** @var InventoryTransferCollection Collection of inventorytransfers. */
    public InventoryTransferCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): InventoryTransferPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): InventoryTransferPaginator
    {
        if(is_null($this->postParams)){
