 ...
 */
class ContactWebhookUdfFieldPaginator
{
    /** @var ContactWebhookUdfFieldCollection Collection of contactwebhookudffields. */
    public ContactWebhookUdfFieldCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContactWebhookUdfFieldCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContactWebhookUdfFieldPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContactWebhookUdfFieldPaginator
    {
        if(is_null($this->postParams)){
