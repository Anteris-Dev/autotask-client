 ...
 */
class WebhookEventErrorLogPaginator
{
    /** @var WebhookEventErrorLogCollection Collection of webhookeventerrorlogs. */
    public WebhookEventErrorLogCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): WebhookEventErrorLogPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): WebhookEventErrorLogPaginator
    {
        if(is_null($this->postParams)){
