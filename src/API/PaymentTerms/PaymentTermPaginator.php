 ...
 */
class PaymentTermPaginator
{
    /** @var PaymentTermCollection Collection of paymentterms. */
    public PaymentTermCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = PaymentTermCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): PaymentTermPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): PaymentTermPaginator
    {
        if(is_null($this->postParams)){
