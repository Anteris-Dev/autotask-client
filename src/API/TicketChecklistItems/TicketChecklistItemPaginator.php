 ...
 */
class TicketChecklistItemPaginator
{
    /** @var TicketChecklistItemCollection Collection of ticketchecklistitems. */
    public TicketChecklistItemCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketChecklistItemCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketChecklistItemPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketChecklistItemPaginator
    {
        if(is_null($this->postParams)){
