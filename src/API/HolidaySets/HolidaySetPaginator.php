 ...
 */
class HolidaySetPaginator
{
    /** @var HolidaySetCollection Collection of holidaysets. */
    public HolidaySetCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = HolidaySetCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): HolidaySetPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): HolidaySetPaginator
    {
        if(is_null($this->postParams)){
