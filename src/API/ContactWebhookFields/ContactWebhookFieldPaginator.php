 ...
 */
class ContactWebhookFieldPaginator
{
    /** @var ContactWebhookFieldCollection Collection of contactwebhookfields. */
    public ContactWebhookFieldCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContactWebhookFieldCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContactWebhookFieldPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContactWebhookFieldPaginator
    {
        if(is_null($this->postParams)){
