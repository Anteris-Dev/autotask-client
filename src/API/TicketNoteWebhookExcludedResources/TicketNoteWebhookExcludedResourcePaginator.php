 ...
 */
class TicketNoteWebhookExcludedResourcePaginator
{
    /** @var TicketNoteWebhookExcludedResourceCollection Collection of ticketnotewebhookexcludedresources. */
    public TicketNoteWebhookExcludedResourceCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketNoteWebhookExcludedResourceCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketNoteWebhookExcludedResourcePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketNoteWebhookExcludedResourcePaginator
    {
        if(is_null($this->postParams)){
