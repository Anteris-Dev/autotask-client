 ...
 */
class ExpenseItemPaginator
{
    /** @var ExpenseItemCollection Collection of expenseitems. */
    public ExpenseItemCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ExpenseItemCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ExpenseItemPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ExpenseItemPaginator
    {
        if(is_null($this->postParams)){
