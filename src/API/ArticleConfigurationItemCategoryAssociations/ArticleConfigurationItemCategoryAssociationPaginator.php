 ...
 */
class ArticleConfigurationItemCategoryAssociationPaginator
{
    /** @var ArticleConfigurationItemCategoryAssociationCollection Collection of articleconfigurationitemcategoryassociations. */
    public ArticleConfigurationItemCategoryAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ArticleConfigurationItemCategoryAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ArticleConfigurationItemCategoryAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ArticleConfigurationItemCategoryAssociationPaginator
    {
        if(is_null($this->postParams)){
