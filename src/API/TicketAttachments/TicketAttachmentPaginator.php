 ...
 */
class TicketAttachmentPaginator
{
    /** @var TicketAttachmentCollection Collection of ticketattachments. */
    public TicketAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketAttachmentPaginator
    {
        if(is_null($this->postParams)){
