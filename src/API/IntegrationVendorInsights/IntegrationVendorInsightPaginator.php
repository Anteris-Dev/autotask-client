 ...
 */
class IntegrationVendorInsightPaginator
{
    /** @var IntegrationVendorInsightCollection Collection of integrationvendorinsights. */
    public IntegrationVendorInsightCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = IntegrationVendorInsightCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): IntegrationVendorInsightPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): IntegrationVendorInsightPaginator
    {
        if(is_null($this->postParams)){
