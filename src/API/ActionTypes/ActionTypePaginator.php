 ...
 */
class ActionTypePaginator
{
    /** @var ActionTypeCollection Collection of actiontypes. */
    public ActionTypeCollection $collection;
    ...
    {
        $contacts = ActionTypeCollection::fromResponse($response);
