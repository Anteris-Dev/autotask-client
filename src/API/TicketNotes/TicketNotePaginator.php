 ...
 */
class TicketNotePaginator
{
    /** @var TicketNoteCollection Collection of ticketnotes. */
    public TicketNoteCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketNoteCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketNotePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketNotePaginator
    {
        if(is_null($this->postParams)){
