 ...
 */
class InventoryProductPaginator
{
    /** @var InventoryProductCollection Collection of inventoryproducts. */
    public InventoryProductCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = InventoryProductCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): InventoryProductPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): InventoryProductPaginator
    {
        if(is_null($this->postParams)){
