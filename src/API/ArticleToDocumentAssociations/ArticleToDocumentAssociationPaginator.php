 ...
 */
class ArticleToDocumentAssociationPaginator
{
    /** @var ArticleToDocumentAssociationCollection Collection of articletodocumentassociations. */
    public ArticleToDocumentAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ArticleToDocumentAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ArticleToDocumentAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ArticleToDocumentAssociationPaginator
    {
        if(is_null($this->postParams)){
