 ...
 */
class SubscriptionPeriodPaginator
{
    /** @var SubscriptionPeriodCollection Collection of subscriptionperiods. */
    public SubscriptionPeriodCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = SubscriptionPeriodCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): SubscriptionPeriodPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): SubscriptionPeriodPaginator
    {
        if(is_null($this->postParams)){
