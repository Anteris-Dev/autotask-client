 ...
 */
class ServiceLevelAgreementResultPaginator
{
    /** @var ServiceLevelAgreementResultCollection Collection of servicelevelagreementresults. */
    public ServiceLevelAgreementResultCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ServiceLevelAgreementResultCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ServiceLevelAgreementResultPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ServiceLevelAgreementResultPaginator
    {
        if(is_null($this->postParams)){
