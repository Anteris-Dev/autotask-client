 ...
 */
class ProjectNoteAttachmentPaginator
{
    /** @var ProjectNoteAttachmentCollection Collection of projectnoteattachments. */
    public ProjectNoteAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ProjectNoteAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ProjectNoteAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ProjectNoteAttachmentPaginator
    {
        if(is_null($this->postParams)){
