 ...
 */
class ServiceCallTicketPaginator
{
    /** @var ServiceCallTicketCollection Collection of servicecalltickets. */
    public ServiceCallTicketCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ServiceCallTicketPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ServiceCallTicketPaginator
    {
        if(is_null($this->postParams)){
