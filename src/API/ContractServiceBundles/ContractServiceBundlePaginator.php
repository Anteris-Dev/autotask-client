 ...
 */
class ContractServiceBundlePaginator
{
    /** @var ContractServiceBundleCollection Collection of contractservicebundles. */
    public ContractServiceBundleCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractServiceBundleCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractServiceBundlePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractServiceBundlePaginator
    {
        if(is_null($this->postParams)){
