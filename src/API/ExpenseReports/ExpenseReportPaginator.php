 ...
 */
class ExpenseReportPaginator
{
    /** @var ExpenseReportCollection Collection of expensereports. */
    public ExpenseReportCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ExpenseReportCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ExpenseReportPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ExpenseReportPaginator
    {
        if(is_null($this->postParams)){
