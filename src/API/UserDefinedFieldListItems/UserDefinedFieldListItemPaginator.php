 ...
 */
class UserDefinedFieldListItemPaginator
{
    /** @var UserDefinedFieldListItemCollection Collection of userdefinedfieldlistitems. */
    public UserDefinedFieldListItemCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): UserDefinedFieldListItemPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): UserDefinedFieldListItemPaginator
    {
        if(is_null($this->postParams)){
