 ...
 */
class ContractTicketPurchasePaginator
{
    /** @var ContractTicketPurchaseCollection Collection of contractticketpurchases. */
    public ContractTicketPurchaseCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractTicketPurchasePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractTicketPurchasePaginator
    {
        if(is_null($this->postParams)){
