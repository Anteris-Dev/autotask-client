 ...
 */
class ProductVendorPaginator
{
    /** @var ProductVendorCollection Collection of productvendors. */
    public ProductVendorCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ProductVendorPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ProductVendorPaginator
    {
        if(is_null($this->postParams)){
