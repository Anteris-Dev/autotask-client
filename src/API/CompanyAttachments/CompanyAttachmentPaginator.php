 ...
 */
class CompanyAttachmentPaginator
{
    /** @var CompanyAttachmentCollection Collection of companyattachments. */
    public CompanyAttachmentCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CompanyAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CompanyAttachmentPaginator
    {
        if(is_null($this->postParams)){
