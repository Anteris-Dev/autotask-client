 ...
 */
class TaskAttachmentPaginator
{
    /** @var TaskAttachmentCollection Collection of taskattachments. */
    public TaskAttachmentCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TaskAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TaskAttachmentPaginator
    {
        if(is_null($this->postParams)){
