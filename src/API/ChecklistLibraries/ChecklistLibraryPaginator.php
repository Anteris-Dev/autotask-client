 ...
 */
class ChecklistLibraryPaginator
{
    /** @var ChecklistLibraryCollection Collection of checklistlibraries. */
    public ChecklistLibraryCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ChecklistLibraryCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ChecklistLibraryPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ChecklistLibraryPaginator
    {
        if(is_null($this->postParams)){
