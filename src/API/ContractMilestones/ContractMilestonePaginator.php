 ...
 */
class ContractMilestonePaginator
{
    /** @var ContractMilestoneCollection Collection of contractmilestones. */
    public ContractMilestoneCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractMilestoneCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractMilestonePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractMilestonePaginator
    {
        if(is_null($this->postParams)){
