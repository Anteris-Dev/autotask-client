 ...
 */
class DocumentNotePaginator
{
    /** @var DocumentNoteCollection Collection of documentnotes. */
    public DocumentNoteCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DocumentNoteCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): DocumentNotePaginator
    {
