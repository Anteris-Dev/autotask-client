 ...
 */
class ConfigurationItemNotePaginator
{
    /** @var ConfigurationItemNoteCollection Collection of configurationitemnotes. */
    public ConfigurationItemNoteCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ConfigurationItemNoteCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ConfigurationItemNotePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ConfigurationItemNotePaginator
    {
        if(is_null($this->postParams)){
