 ...
 */
class ContractServiceUnitPaginator
{
    /** @var ContractServiceUnitCollection Collection of contractserviceunits. */
    public ContractServiceUnitCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractServiceUnitPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractServiceUnitPaginator
    {
        if(is_null($this->postParams)){
