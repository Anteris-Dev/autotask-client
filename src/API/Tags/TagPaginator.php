...
class TagPaginator
{
    /** @var TagCollection Collection of tags. */
    ...
    {
        $this->client = $client;
        $this->collection = TagCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TagPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TagPaginator
    {
        if(is_null($this->postParams)){
