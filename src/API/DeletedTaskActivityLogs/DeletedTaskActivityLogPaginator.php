 ...
 */
class DeletedTaskActivityLogPaginator
{
    /** @var DeletedTaskActivityLogCollection Collection of deletedtaskactivitylogs. */
    public DeletedTaskActivityLogCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DeletedTaskActivityLogCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): DeletedTaskActivityLogPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): DeletedTaskActivityLogPaginator
    {
        if(is_null($this->postParams)){
