 ...
 */
class SkillPaginator
{
    /** @var SkillCollection Collection of skills. */
    ...
    {
        $this->client = $client;
        $this->collection = SkillCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): SkillPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): SkillPaginator
    {
        if(is_null($this->postParams)){
