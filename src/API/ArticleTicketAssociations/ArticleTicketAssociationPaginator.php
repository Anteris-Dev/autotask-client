 ...
 */
class ArticleTicketAssociationPaginator
{
    /** @var ArticleTicketAssociationCollection Collection of articleticketassociations. */
    public ArticleTicketAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ArticleTicketAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ArticleTicketAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ArticleTicketAssociationPaginator
    {
        if(is_null($this->postParams)){
