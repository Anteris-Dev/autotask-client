 ...
 */
class PriceListProductTierPaginator
{
    /** @var PriceListProductTierCollection Collection of pricelistproducttiers. */
    public PriceListProductTierCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = PriceListProductTierCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): PriceListProductTierPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): PriceListProductTierPaginator
    {
        if(is_null($this->postParams)){
