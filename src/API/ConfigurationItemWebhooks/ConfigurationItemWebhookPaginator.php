 ...
 */
class ConfigurationItemWebhookPaginator
{
    /** @var ConfigurationItemWebhookCollection Collection of configurationitemwebhooks. */
    public ConfigurationItemWebhookCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ConfigurationItemWebhookCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ConfigurationItemWebhookPaginator
    {
        if(is_null($this->postParams)){
