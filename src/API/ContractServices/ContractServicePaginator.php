 ...
 */
class ContractServicePaginator
{
    /** @var ContractServiceCollection Collection of contractservices. */
    public ContractServiceCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractServiceCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractServicePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractServicePaginator
    {
        if(is_null($this->postParams)){
