 ...
 */
class ContractNotePaginator
{
    /** @var ContractNoteCollection Collection of contractnotes. */
    public ContractNoteCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractNoteCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractNotePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractNotePaginator
    {
        if(is_null($this->postParams)){
