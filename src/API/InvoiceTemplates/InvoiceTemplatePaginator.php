 ...
 */
class InvoiceTemplatePaginator
{
    /** @var InvoiceTemplateCollection Collection of invoicetemplates. */
    public InvoiceTemplateCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = InvoiceTemplateCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): InvoiceTemplatePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): InvoiceTemplatePaginator
    {
        if(is_null($this->postParams)){
