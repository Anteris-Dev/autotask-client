 ...
 */
class OpportunityCategoryPaginator
{
    /** @var OpportunityCategoryCollection Collection of opportunitycategories. */
    public OpportunityCategoryCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = OpportunityCategoryCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): OpportunityCategoryPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): OpportunityCategoryPaginator
    {
        if(is_null($this->postParams)){
