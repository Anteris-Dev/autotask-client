 ...
 */
class ConfigurationItemCategoryUdfAssociationPaginator
{
    /** @var ConfigurationItemCategoryUdfAssociationCollection Collection of configurationitemcategoryudfassociations. */
    public ConfigurationItemCategoryUdfAssociationCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ConfigurationItemCategoryUdfAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ConfigurationItemCategoryUdfAssociationPaginator
    {
        if(is_null($this->postParams)){
