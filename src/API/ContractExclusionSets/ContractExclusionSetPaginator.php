 ...
 */
class ContractExclusionSetPaginator
{
    /** @var ContractExclusionSetCollection Collection of contractexclusionsets. */
    public ContractExclusionSetCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ContractExclusionSetCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ContractExclusionSetPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ContractExclusionSetPaginator
    {
        if(is_null($this->postParams)){
