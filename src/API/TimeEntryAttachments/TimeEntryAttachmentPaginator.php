 ...
 */
class TimeEntryAttachmentPaginator
{
    /** @var TimeEntryAttachmentCollection Collection of timeentryattachments. */
    public TimeEntryAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TimeEntryAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TimeEntryAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TimeEntryAttachmentPaginator
    {
        if(is_null($this->postParams)){
