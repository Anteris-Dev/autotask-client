 ...
 */
class CompanyWebhookUdfFieldPaginator
{
    /** @var CompanyWebhookUdfFieldCollection Collection of companywebhookudffields. */
    public CompanyWebhookUdfFieldCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CompanyWebhookUdfFieldPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CompanyWebhookUdfFieldPaginator
    {
        if(is_null($this->postParams)){
