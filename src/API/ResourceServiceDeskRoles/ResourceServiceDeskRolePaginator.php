 ...
 */
class ResourceServiceDeskRolePaginator
{
    /** @var ResourceServiceDeskRoleCollection Collection of resourceservicedeskroles. */
    public ResourceServiceDeskRoleCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ResourceServiceDeskRolePaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ResourceServiceDeskRolePaginator
    {
        if(is_null($this->postParams)){
