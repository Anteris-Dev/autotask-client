 ...
 */
class OrganizationalLevelAssociationPaginator
{
    /** @var OrganizationalLevelAssociationCollection Collection of organizationallevelassociations. */
    public OrganizationalLevelAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = OrganizationalLevelAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): OrganizationalLevelAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): OrganizationalLevelAssociationPaginator
    {
        if(is_null($this->postParams)){
