 ...
 */
class ServiceCallTaskPaginator
{
    /** @var ServiceCallTaskCollection Collection of servicecalltasks. */
    public ServiceCallTaskCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ServiceCallTaskCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ServiceCallTaskPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ServiceCallTaskPaginator
    {
        if(is_null($this->postParams)){
