 ...
 */
class InternalLocationWithBusinessHourPaginator
{
    /** @var InternalLocationWithBusinessHourCollection Collection of internallocationwithbusinesshours. */
    public InternalLocationWithBusinessHourCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = InternalLocationWithBusinessHourCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): InternalLocationWithBusinessHourPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): InternalLocationWithBusinessHourPaginator
    {
        if(is_null($this->postParams)){
