 ...
 */
class ServiceCallPaginator
{
    /** @var ServiceCallCollection Collection of servicecalls. */
    public ServiceCallCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = ServiceCallCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): ServiceCallPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): ServiceCallPaginator
    {
        if(is_null($this->postParams)){
