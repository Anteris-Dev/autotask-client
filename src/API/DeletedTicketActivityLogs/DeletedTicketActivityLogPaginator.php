 ...
 */
class DeletedTicketActivityLogPaginator
{
    /** @var DeletedTicketActivityLogCollection Collection of deletedticketactivitylogs. */
    public DeletedTicketActivityLogCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = DeletedTicketActivityLogCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): DeletedTicketActivityLogPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): DeletedTicketActivityLogPaginator
    {
        if(is_null($this->postParams)){
