 ...
 */
class CompanyTeamPaginator
{
    /** @var CompanyTeamCollection Collection of companyteams. */
    public CompanyTeamCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = CompanyTeamCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): CompanyTeamPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): CompanyTeamPaginator
    {
        if(is_null($this->postParams)){
