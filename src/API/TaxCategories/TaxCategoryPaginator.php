 ...
 */
class TaxCategoryPaginator
{
    /** @var TaxCategoryCollection Collection of taxcategories. */
    public TaxCategoryCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TaxCategoryPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TaxCategoryPaginator
    {
        if(is_null($this->postParams)){
