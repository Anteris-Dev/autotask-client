 ...
 */
class TicketAdditionalConfigurationItemPaginator
{
    /** @var TicketAdditionalConfigurationItemCollection Collection of ticketadditionalconfigurationitems. */
    public TicketAdditionalConfigurationItemCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketAdditionalConfigurationItemCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketAdditionalConfigurationItemPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketAdditionalConfigurationItemPaginator
    {
        if(is_null($this->postParams)){
