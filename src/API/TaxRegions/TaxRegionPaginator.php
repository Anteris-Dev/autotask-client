 ...
 */
class TaxRegionPaginator
{
    /** @var TaxRegionCollection Collection of taxregions. */
    public TaxRegionCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TaxRegionCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TaxRegionPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TaxRegionPaginator
    {
        if(is_null($this->postParams)){
