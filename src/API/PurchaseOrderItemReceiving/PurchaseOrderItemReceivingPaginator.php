 ...
 */
class PurchaseOrderItemReceivingPaginator
{
    /** @var PurchaseOrderItemReceivingCollection Collection of purchaseorderitemreceiving. */
    public PurchaseOrderItemReceivingCollection $collection;
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): PurchaseOrderItemReceivingPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): PurchaseOrderItemReceivingPaginator
    {
        if(is_null($this->postParams)){
