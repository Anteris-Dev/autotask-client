...
/**
 * Represents AttachmentNestedAttachment entities.
 */
class AttachmentNestedAttachmentEntity extends DataTransferObject
{
    ...
    /**
     * Creates a new AttachmentNestedAttachment entity.
