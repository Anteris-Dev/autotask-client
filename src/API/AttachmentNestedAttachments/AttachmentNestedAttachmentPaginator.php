 ...
 */
class AttachmentNestedAttachmentPaginator
{
    /** @var AttachmentNestedAttachmentCollection Collection of attachmentnestedattachments. */
    public AttachmentNestedAttachmentCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = AttachmentNestedAttachmentCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): AttachmentNestedAttachmentPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): AttachmentNestedAttachmentPaginator
    {
