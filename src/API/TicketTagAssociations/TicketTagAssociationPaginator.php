 ...
 */
class TicketTagAssociationPaginator
{
    /** @var TicketTagAssociationCollection Collection of tickettagassociations. */
    public TicketTagAssociationCollection $collection;
    ...
    {
        $this->client = $client;
        $this->collection = TicketTagAssociationCollection::fromResponse($response);
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function nextPage(): TicketTagAssociationPaginator
    {
     ...
     * @author Aidan Casey <aidan.casey@anteris.com>
     */
    public function prevPage (): TicketTagAssociationPaginator
    {
        if(is_null($this->postParams)){
